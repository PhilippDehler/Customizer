...
const NavbarToggle = (p) => {
    ...
    return (<Dynamic component={local.as} {...props} type={local.as === "button" ? "button" : undefined} onClick={handleClick} aria-label={local.label} class={classNames(local.class, local.className, bsPrefix, !context?.expanded && "collapsed")}>
