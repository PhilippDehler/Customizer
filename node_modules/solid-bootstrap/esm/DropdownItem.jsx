...
const DropdownItem = (p) => {
    ...
    return (<Dynamic component={local.as} {...props} {...dropdownItemProps} class={classNames(local.class, local.className, prefix, meta.isActive && "active", local.disabled && "disabled")}/>);
};
