...
const NavLink = (p) => {
    ...
    return (<Dynamic component={local.as} {...props} {...navItemProps} class={classNames(local.class, local.className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")}/>);
};
