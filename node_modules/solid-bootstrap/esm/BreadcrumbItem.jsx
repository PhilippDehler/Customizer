...
const BreadcrumbItem = (p) => {
    ...
    return (<Dynamic component={local.as} {...props} class={classNames(prefix, local.class, local.className, { active: local.active })} aria-current={local.active ? "page" : undefined}>
