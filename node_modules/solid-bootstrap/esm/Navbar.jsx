...
const Navbar = (p) => {
    ...
    return (<NavbarContext.Provider value={navbarContext}>
      <SelectableContext.Provider value={handleCollapse}>
        ...
        props.role === undefined && local.as !== "nav" ? "Navigation" : props.role} class={classNames(local.class, local.className, bsPrefix, local.expand && expandClass(), local.variant && `${bsPrefix}-${local.variant}`, local.bg && `bg-${local.bg}`, local.sticky && `sticky-${local.sticky}`, local.fixed && `fixed-${local.fixed}`)}/>
