...
const ListGroup = (p) => {
    ...
    return (<BaseNav as={local.as} {...props} activeKey={activeKey()} onSelect={onSelect} class={classNames(local.class, local.className, bsPrefix, local.variant && `${bsPrefix}-${local.variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, local.numbered && `${bsPrefix}-numbered`)}/>);
};
