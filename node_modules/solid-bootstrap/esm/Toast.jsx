...
const Toast = (p) => {
    ...
    const ToastInner = () => (<div {...props} class={classNames(bsPrefix, local.class, local.className, local.bg && `bg-${local.bg}`, !hasAnimation && (local.show ? "show" : "hide"))} role="alert" aria-live="assertive" aria-atomic="true"/>);
