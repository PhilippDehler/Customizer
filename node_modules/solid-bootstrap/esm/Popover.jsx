...
const Popover = (p) => {
    ...
    return (<div role="tooltip" x-placement={primaryPlacement()} class={classNames(local.class, local.className, decoratedBsPrefix, primaryPlacement() && `bs-popover-auto`)} {...props} {...context?.wrapperProps} style={Object.assign({}, local.style, context?.wrapperProps?.style)}>
