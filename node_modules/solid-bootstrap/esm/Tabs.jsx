...
function RenderTab(props) {
    ...
    return (<NavItem as="li" role="presentation">
      <NavLink as="button" type="button" eventKey={props.eventKey} disabled={props.disabled} id={props.id} class={classNames(props.tabClass, props.tabClassName)} {...(props.tabAttrs || {})}>
        {props.title}
      </NavLink>
    </NavItem>);
}
