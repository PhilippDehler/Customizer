...
const Modal = (p) => {
    ...
    const renderBackdrop = (backdropProps) => (<div {...backdropProps} class={classNames(`${bsPrefix}-backdrop`, local.backdropClass, local.backdropClassName, !local.animation && "show")}/>);
    ...
    const renderDialog = (dialogProps) => (<div role="dialog" {...dialogProps} style={baseModalStyle()} class={classNames(local.class, local.className, bsPrefix, animateStaticModal() && `${bsPrefix}-static`)} onClick={local.backdrop ? handleClick : undefined} onMouseUp={handleMouseUp} aria-labelledby={local["aria-labelledby"]}>
      <Dynamic component={local.dialogAs} {...props} onMouseDown={handleDialogMouseDown} class={classNames(local.dialogClass, local.dialogClassName)} contentClass={classNames(local.contentClass, local.contentClassName)}>
        {local.children}
      </Dynamic>
    </div>);
