...
const DropdownToggle = (p) => {
    ...
    return (<Dynamic component={local.as} class={classNames(local.class, local.className, prefix, local.split && `${prefix}-split`, !!isInputGroup && dropdownContext?.show && "show")} {...toggleOther} {...props} ref={mergedRef}/>);
};
