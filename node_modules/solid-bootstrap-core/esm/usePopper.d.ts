 ...
 */
export declare function usePopper(referenceElement: () => VirtualElement | null | undefined, popperElement: () => HTMLElement | null | undefined, options: DeepReadonly<UsePopperOptions>): Accessor<UsePopperState | undefined>;
