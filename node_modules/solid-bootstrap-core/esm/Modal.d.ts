...
export declare type ModalTransitionComponent = Component<{
    in: boolean;
    appear?: boolean;
...
export declare const Modal: (p: ModalProps) => JSX.Element;
declare const _default: ((p: ModalProps) => JSX.Element) & {
