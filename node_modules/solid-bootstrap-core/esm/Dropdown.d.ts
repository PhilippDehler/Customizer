...
export declare type ToggleEvent = KeyboardEvent | MouseEvent;
 ...
 * @public
 */
export declare function Dropdown(p: DropdownProps): JSX.Element;
export declare namespace Dropdown {
    var Menu: typeof DropdownMenu;
    var Toggle: typeof DropdownToggle;
    var Item: import("./types").DynamicRefForwardingComponent<(props: import("./Button").ButtonProps) => JSX.Element, DropdownItemProps<HTMLButtonElement>>;
}
