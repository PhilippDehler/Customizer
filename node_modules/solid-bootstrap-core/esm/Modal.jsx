...
import { children, createComputed, createEffect, createSignal, mergeProps, on, onCleanup, onMount, splitProps, Show, createMemo, } from "solid-js";
...
export const Modal = (p) => {
    ...
    let innerDialog = () => local.renderDialog ? (local.renderDialog(dialogProps)) : (<div {...dialogProps}>{getChildAsDocument()}</div>);
    const Dialog = () => {
